...
def run_agentic_loop(
    ...
    system_prompt = (
        ...
        "CRITICAL RULES: "
        "0. API AUTHENTICATION: ALL query_api calls MUST use authentication. The LMS_API_KEY is automatically loaded and sent as 'Authorization: Bearer <key>' header. NEVER call query_api without authentication — the backend will reject unauthenticated requests with 401 Unauthorized. "
